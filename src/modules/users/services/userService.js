...
exports.registerUser = async (userData) => {
  ...
  const tokenTemporal = jwt.sign({ id: newUser.id, temporal: true }, process.env.JWT_SECRET, { expiresIn: '3d' });
  return { user, tokenTemporal  }; // Return the user and the tempToken
};
